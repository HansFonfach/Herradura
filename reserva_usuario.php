  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">La Herradura te informa</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
       <strong ><p>¡TIEMPO!   </strong ><br>Destacamos los valores y la puntualidad, Respeto por tu tiempo y por el de los demás 
(Tiempo máximo de espera 15 minutos)</p>
      
<strong > <p>¡CORTE Y BARBA!  </strong ><br> Reserva 2 horas para éste servicio, idealmente seguidas para tú mayor comodidad</p>


<p>Ahora si ¡AGENDALE! </p>
